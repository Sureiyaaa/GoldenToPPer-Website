...
function resolveImageUrl(src: string | undefined | null): string {
  ...
  if (!src || src.trim() === '') {
    ...
    return ''; // Empty images use the section's background until an image is selected.
...
export default function HomePreviewSkeleton({
  ...
  return (
    ...
    <div className="relative overflow-x-hidden bg-white font-sans text-gray-900 selection:bg-brand-gold/30">

      {/* 1. HERO SECTION */}

      <section id="homepage-preview-hero-section" 
        ...
        className={`relative h-[85vh] w-full overflow-hidden bg-black cursor-pointer transition-all ${
          ...
          selectedRegion.startsWith('slide:') || selectedRegion === 'hero-section' ? 'ring-2 ring-inset ring-brand-gold' : 'hover:ring-2 hover:ring-inset hover:ring-white/50'
      ...
      <section id="homepage-preview-about-section"

        onClick={(e) => select(e, 'about-section')}

        className={`py-24 bg-white px-6 md:px-12 cursor-pointer transition-all ${

          selectedRegion === 'about-section' ? 'ring-2 ring-inset ring-brand-gold' : 'hover:ring-2 hover:ring-inset hover:ring-brand-blue/20'
      ...
      <section id="homepage-preview-dev-areas" 

        onClick={(e) => select(e, `dev-item:${activeDev}`)}

        className={`py-20 bg-[#E7E7E7] px-6 md:px-12 cursor-pointer transition-all ${

          selectedRegion === 'dev-areas' || selectedRegion.startsWith('dev-item:') ? 'ring-2 ring-inset ring-brand-gold' : 'hover:ring-2 hover:ring-inset hover:ring-brand-blue/20'
      ...
      <section id="homepage-preview-awards-section"

        onClick={(e) => select(e, 'awards-section')}

        className={`py-8 bg-brand-blue text-white cursor-pointer transition-all ${

          selectedRegion === 'awards-section' || selectedRegion.startsWith('award:') ? 'ring-2 ring-inset ring-brand-gold' : 'hover:ring-2 hover:ring-inset hover:ring-white/50'
      ...
      <section id="homepage-preview-process-section"

        onClick={(e) => select(e, 'process-section')}

        className={`py-24 px-6 md:px-12 max-w-[90rem] mx-auto cursor-pointer transition-all ${

          selectedRegion === 'process-section' || selectedRegion.startsWith('process-step:') ? 'ring-2 ring-inset ring-brand-gold' : 'hover:ring-2 hover:ring-inset hover:ring-brand-blue/20'
      ...
      <section id="homepage-preview-video-section"
        ...
        className={`h-screen bg-black text-white relative flex flex-col items-center justify-center cursor-pointer transition-all ${
          ...
          selectedRegion === 'video-section' ? 'ring-2 ring-inset ring-brand-gold' : 'hover:ring-2 hover:ring-inset hover:ring-white/50'
      ...
      <section id="homepage-preview-news-section"

        onClick={(e) => select(e, 'news-section')}

        className={`max-w-[90rem] mx-auto px-6 md:px-12 py-24 cursor-pointer transition-all ${

          selectedRegion === 'news-section' || selectedRegion.startsWith('news-item:') ? 'ring-2 ring-inset ring-brand-gold' : 'hover:ring-2 hover:ring-inset hover:ring-brand-blue/20'
